...
def main(args):
    ...
    writer = SummaryWriter(log_dir=f'runs/{dataname}_{int(time.time())}')  # TensorBoard initialization
    ...
    for epoch in range(num_epochs):
        ...
        # TensorBoard logging
        writer.add_scalar('Loss/Train MSE', num_loss, epoch)
        writer.add_scalar('Loss/Train CE', cat_loss, epoch)
        writer.add_scalar('Loss/Train KL', kl_loss, epoch)
        writer.add_scalar('Loss/Val MSE', val_mse_loss.item(), epoch)
